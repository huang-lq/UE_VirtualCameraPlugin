...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUE_VCamBPLibrary_OpenVCamBatFile_Statics::NewProp_OpenFile = { "OpenFile", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UE_VCamBPLibrary_eventOpenVCamBatFile_Parms), &Z_Construct_UFunction_UUE_VCamBPLibrary_OpenVCamBatFile_Statics::NewProp_OpenFile_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUE_VCamBPLibrary_OpenVCamBatFile_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUE_VCamBPLibrary, nullptr, "OpenVCamBatFile", nullptr, nullptr, Z_Construct_UFunction_UUE_VCamBPLibrary_OpenVCamBatFile_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUE_VCamBPLibrary_OpenVCamBatFile_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUE_VCamBPLibrary_OpenVCamBatFile_Statics::UE_VCamBPLibrary_eventOpenVCamBatFile_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUE_VCamBPLibrary_OpenVCamBatFile_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUE_VCamBPLibrary_OpenVCamBatFile_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUE_VCamBPLibrary_OpenVCamBatFile_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UUE_VCamBPLibrary_OpenVCamBatFile_Statics::UE_VCamBPLibrary_eventOpenVCamBatFile_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUE_VCamBPLibrary_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UUE_VCamBPLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUE_VCamBPLibrary_OpenVCamBatFile, "OpenVCamBatFile" }, // 2086277184
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUE_VCamBPLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUE_VCamBPLibrary_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUE_VCamBPLibrary_Statics::Class_MetaDataParams), Z_Construct_UClass_UUE_VCamBPLibrary_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Project_UE_Test_Plugins_UE_VCam_Source_UE_VCam_Public_UE_VCamBPLibrary_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Project_UE_Test_Plugins_UE_VCam_Source_UE_VCam_Public_UE_VCamBPLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUE_VCamBPLibrary, UUE_VCamBPLibrary::StaticClass, TEXT("UUE_VCamBPLibrary"), &Z_Registration_Info_UClass_UUE_VCamBPLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUE_VCamBPLibrary), 3437261690U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Project_UE_Test_Plugins_UE_VCam_Source_UE_VCam_Public_UE_VCamBPLibrary_h_2284277359(TEXT("/Script/UE_VCam"),
		Z_CompiledInDeferFile_FID_Project_UE_Test_Plugins_UE_VCam_Source_UE_VCam_Public_UE_VCamBPLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Project_UE_Test_Plugins_UE_VCam_Source_UE_VCam_Public_UE_VCamBPLibrary_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
