...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AGetGameData_StartGetData_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(GetGameData_eventStartGetData_Parms), &Z_Construct_UFunction_AGetGameData_StartGetData_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AGetGameData_StartGetData_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AGetGameData, nullptr, "StartGetData", nullptr, nullptr, Z_Construct_UFunction_AGetGameData_StartGetData_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AGetGameData_StartGetData_Statics::PropPointers), sizeof(Z_Construct_UFunction_AGetGameData_StartGetData_Statics::GetGameData_eventStartGetData_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AGetGameData_StartGetData_Statics::Function_MetaDataParams), Z_Construct_UFunction_AGetGameData_StartGetData_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AGetGameData_StartGetData_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AGetGameData_StartGetData_Statics::GetGameData_eventStartGetData_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AGetGameData_StopGetData_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AGetGameData, nullptr, "StopGetData", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AGetGameData_StopGetData_Statics::Function_MetaDataParams), Z_Construct_UFunction_AGetGameData_StopGetData_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AGetGameData_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_AGetGameData_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AGetGameData_StartGetData, "StartGetData" }, // 682128486
		{ &Z_Construct_UFunction_AGetGameData_StopGetData, "StopGetData" }, // 3422383794
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AGetGameData_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AGetGameData_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AGetGameData_Statics::Class_MetaDataParams), Z_Construct_UClass_AGetGameData_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Project_UE_Test_Plugins_UE_VCam_Source_UE_VCam_Public_GetGameData_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Project_UE_Test_Plugins_UE_VCam_Source_UE_VCam_Public_GetGameData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGetGameData, AGetGameData::StaticClass, TEXT("AGetGameData"), &Z_Registration_Info_UClass_AGetGameData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGetGameData), 586976600U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Project_UE_Test_Plugins_UE_VCam_Source_UE_VCam_Public_GetGameData_h_569571556(TEXT("/Script/UE_VCam"),
		Z_CompiledInDeferFile_FID_Project_UE_Test_Plugins_UE_VCam_Source_UE_VCam_Public_GetGameData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Project_UE_Test_Plugins_UE_VCam_Source_UE_VCam_Public_GetGameData_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
